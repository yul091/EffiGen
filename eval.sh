...
method=AdativeKV  # AdativeKV, ReasonKV, NormKV, fullkv
max_capacity_prompts=128  # 128,2048 in paper
model_name=mistral-7b-instruct-v0.2  # meta-llama-3-8b-instruct, mistral-7b-instruct-v0.2, mixtral-8x7b-instruct-v0.1
beta=1.005
temp=1
