...
for max_capacity_prompts in 128; do
    for model_path in meta-llama/Meta-Llama-3-8B-Instruct; do
    # for model_path in mistralai/Mixtral-8x7B-Instruct-v0.1  mistralai/Mistral-7B-Instruct-v0.2; do
        for method in NormKV; do
