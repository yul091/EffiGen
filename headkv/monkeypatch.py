...
from headkv.adaptive_olmoe_hijack import norm_olmoe_mlp_forward, norm_olmoe_sparse_block_forward, norm_olmoe_decoder_layer_forward, norm_olmoe_attention_forward, norm_olmoe_flash_attn2_forward
